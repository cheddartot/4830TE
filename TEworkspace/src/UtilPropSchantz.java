...
public class UtilPropSchantz {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\C:\\Users\\Cheddartot\\workspace4830\\workspace4830-TE-schantz\\TEworkspace\\WebContent\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "C:\\Users\\Cheddartot\\workspace4830\\workspace4830-TE-schantz\\TEworkspace\\WebContent\\config.properties";
